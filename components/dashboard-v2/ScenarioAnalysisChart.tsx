...
export default function ScenarioAnalysisChart() {
  ...
  async function fetchTrades() {
    ...
    trades.forEach((trade) => {
      ...
      const scenario =
        trade.cenario?.trim() || "Sem cenário"
  ...
  return (
    <AppCard title="Performance By Scenario">
